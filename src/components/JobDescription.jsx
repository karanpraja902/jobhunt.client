...
const JobDescription = () => {
    ...
    const applyJobHandler = async () => {
        try {
            const res = await axios.get(`${VITE_API_BASE_URL}/application/apply/${jobId}`, {withCredentials:true});
    ...
    useEffect(()=>{
        const fetchSingleJob = async () => {
            try {
                const res = await axios.get(`${VITE_API_BASE_URL}/job/get/${jobId}`,{withCredentials:true});
                if(res.data.success){
